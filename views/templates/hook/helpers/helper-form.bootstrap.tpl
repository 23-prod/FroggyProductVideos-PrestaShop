 ...
 *}
                    ...
                    <div class="col-lg-9 ">
                        {if $field.type eq 'radio'}
                            <span class="switch prestashop-switch fixed-width-lg">
                                    ...
                                    <label for="{$field.name|escape:'html':'UTF-8'}_on"> {l s='Yes' mod='froggyproductvideos'}</label>
                                    ...
                                    <label for="{$field.name|escape:'html':'UTF-8'}_off"> {l s='No' mod='froggyproductvideos'}</label>
		...
		<div class="panel-footer">
			<button class="btn btn-default pull-right" name="{$froggyhelper.module_name|escape:'html':'UTF-8'}-submit" id="{$froggyhelper.module_name|escape:'html':'UTF-8'}-form-submit-btn" value="1" type="submit">
				<i class="process-icon-save"></i> {l s='Save' mod='froggyproductvideos'}
			</button>
		</div>
